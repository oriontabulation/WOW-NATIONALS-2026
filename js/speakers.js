...
import { debounce } from './utils.js';  // Updated import path
...
function _buildSpeakerStats(catId) {
    ...
    (state.teams || []).forEach(team => {
        ...
        (team.speakers || []).forEach(speaker => {
            ...
            validSpeakers.set(key, { teamId: team.id, teamName: team.name, teamCode: team.code, displayName: speaker.name });
        });
    });
            ...
            <div class="filter-bar__row">
                ...
                <div class="filter-bar__actions">
                    ${isAdmin ? `
                        ...
                        <div class="dropdown">
                            <button onclick="this.nextElementSibling.classList.toggle('is-open')" class="btn btn-primary btn-xs">⚙️ Manage ▼</button>
