...
function _buildTeams() {
    ...
    <div class="par-search-row">
        <input type="text" id="par-team-search" class="par-search" placeholder="🔍 Search teams…" oninput="window._parFilterTeams()">
...
function _parFilterTeams() {
    const q = document.getElementById('par-team-search')?.value.trim().toLowerCase() || '';
...
function _buildJudges() {
    ...
    return `
    <div class="par-search-row">
        <input type="text" id="par-judge-search" class="par-search" placeholder="🔍 Search judges…" oninput="window._parFilterJudges()">
...
function _parFilterJudges() {
    const q = document.getElementById('par-judge-search')?.value.trim().toLowerCase() || '';
